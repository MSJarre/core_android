...
class IntentService:
    ...
    def handle_utterance(self, message):
        user_id = message.context.get("userid")
        ...
        try:
            ...
            with stopwatch:
                ...
                converse = self._converse(combined, lang, message, user_id)
                if not converse:
            ...
            if converse:
                ...
                self.add_active_skill(skill_id,user_id)
    ...
    def _converse(self, utterances, lang, message, userid=None):
        ...
        for skill in self.active_skills:
            ...
            if skill[2] == userid:
                if self.do_converse(utterances, skill[0], lang, message):
                    ...
                    self.add_active_skill(skill[0], userid)
                    return True
        return False
